  ...
  return knex('comments').del()
    .then(function () {
      ...
      return knex('comments').insert([
        ...
        {id: 2, loca_id: 'MCd01xGZtmfSsH_RUj4pAA', user_id: 2, rating: 3, comment: "This is a great place to hang out on the patio and grab a quick lunch. They have water available if you need it for your dog"},
        {id: 3, loca_id: '0A80IDh1Ag7jW4_D9sjQPQ', user_id: 3, rating: 5, comment: "You can't bring your dog inside. But they have a nice patio area. The food is pretty good, too!"}
      ])
